...
export function UsersManagement() {
  ...
  const [editingSchedule, setEditingSchedule] = useState<{ id: number; name: string } | null>(null);
    ...
    <>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => setEditingSchedule({ id: user.id, name: user.name })}>
      ...
      {editingSchedule && (
        <EditScheduleModal
          ...
          userId={editingSchedule.id}
          userName={editingSchedule.name}
          onSave={() => {
